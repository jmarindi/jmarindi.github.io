...
function onEachFeature(feature, layer) {
    ...
    if (feature.properties.hdx != '') {
      layer.bindPopup('<h4>' + feature.properties.name + '</h4><h5><a target="_blank" href="' + feature.properties.hdx + '"> Number of people in need: ' + feature.properties.pin + ' as of '  + feature.properties.date +  '</a></h5>');
    } else {
