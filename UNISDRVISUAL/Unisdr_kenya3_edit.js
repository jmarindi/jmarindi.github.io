...
function objectify(){
 ...
 //==============================================
  ...
  alldata.map(function(d) {	  
    if (d['Country']== mapclickedcountry) {
				...
				Deaths = {CS_Deaths};
				//DeathObjects.push(CS_Deaths);
				DeathObjects.push(Deaths);
				
				//var Injured,Missing,Housed_Destroyed,Damaged_houses,Victims	Affected,Relocated,Evacuated,LossesUSD,Losses_Local,Educational_centres,Hospitals,Crops_per_ha,Lost_cattle,roads_mts = {};
				
				//var RelocatedObjects,EvacuatedObjects,DisplacedObjects,MissingObjects,InjuredObjects,AffectedObjects,LossesUSDObjects,Losses_LocalObjects,Educational_centresObjects,HospitalsObjects,Crops_per_haObjects,Lost_cattleObjects,roads_mtsObjects,Houses_DestroyedObjects,Damaged_housesObjects = [];
 ...
 // console.log(CS_Missing);
  ...
  {
	  /*DeathObjects.length = 0;
	  RelocatedObjects.length = 0;
      EvacuatedObjects.length = 0;
      DisplacedObjects.length = 0;
      MissingObjects.length = 0;
      InjuredObjects.length = 0;
      AffectedObjects.length = 0;
      LossesUSDObjects.length = 0;
      Losses_LocalObjects.length = 0;
      Educational_centresObjects.length = 0;
      HospitalsObjects.length = 0;
      Crops_per_haObjects.length = 0;
      Lost_cattleObjects.length = 0;
      roads_mtsObjects.length = 0;
      Houses_DestroyedObjects.length = 0;
      Damaged_housesObjects.length = 0; */
	  DeathObjects = [];
	  MissingObjects= [];
      InjuredObjects= [];
	  RelocatedObjects= [];
