 ...
 // var seriesData_2 = clickedRegion.mapAs({x: [0], value: [2]});
  ...
  //Deaths	    Injured	     Missing	Victims	    Affected	    Relocated	  Losses_usd	    Houses_Destroyed	Hospitals	Lost_cattle
