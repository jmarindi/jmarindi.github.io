...
anychart.onDocumentReady(function() {
    ...
    var drawMapChart = function () {
        ...
        map.geoData(anychart.maps["madagascar"]);
        map.title().enabled(true).useHtml(true).text('<span style="color: #212121;">Cummulative People impact in Madagascar</span>').fontSize(18).padding([15,0,15,0]);
