 ...
 // var seriesData_2 = clickedRegion.mapAs({x: [0], value: [2]});
  ...
  //var seriesData_3 = clickedRegion.mapAs({x: [0], value: [3]});
   ...
   var seriesData_9 = SummaryTrend.mapAs({x: [0], value: [9]});
   var seriesData_10 = SummaryTrend.mapAs({x: [0], value: [10]});
   var seriesData_11 = SummaryTrend.mapAs({x: [0], value: [11]});
   var seriesData_12 = SummaryTrend.mapAs({x: [0], value: [12]});
  ...
  //chart.xAxis().labels().padding([5]);
   ...
   //Deaths		Injured		Missing		Victims		Affected		Relocated		Evacuated		Losses_Local		Losses_usd		Houses_Destroyed		Hospitals		Lost_cattle
